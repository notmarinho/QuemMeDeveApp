...
const NumericButton = ({ number, returnNumber }: INumber) => {
  return (
    <Ripple onPress={() => returnNumber(number)} style={styles.numericButton}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.card }]}>
      <View style={styles.valueContainer}>
        <Text style={styles.number}>R$</Text>
        <FakeCurrencyInput
          style={styles.number}
          value={value}
      ...
      <View style={styles.flatlistContainer}>
        <FlatList
          ...
          ListFooterComponent={
            <FooterComponent
              returnNumber={handleAddNumber}
              handleDelete={handleDelete}
            />
          }
          renderItem={({ item }) => (
            <NumericButton number={item} returnNumber={handleAddNumber} />
          )}
        />
      </View>
    </View>
...
const FooterComponent = ({ returnNumber, handleDelete }: IFooter) => {
  return (
    <View style={styles.footer}>
      ...
      <Ripple onPress={handleDelete} style={styles.numericButton}>
